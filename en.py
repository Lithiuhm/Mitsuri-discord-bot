...
def command():
    ...
    value13=f'[------------------------>Here is the invitation<-----------------------](https://discord.com/oauth2/authorize?client_id=761359894791192596&permissions=534760651072&scope=bot)'
...
def invite():
    ...
    value='\n----->¡We thank you for using Mitsuri!<-----\n----------->Here you have the invitation<------------\n------------>[¡invite me to your server!](https://discord.com/oauth2/authorize?client_id=761359894791192596&permissions=534760651072&scope=bot)<------------'
