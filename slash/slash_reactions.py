...
import es
import en
sys.path.append('/Users/santi/Desktop/escritorio/mitsuri-bot/mitsuri_bot_oficial/slash')
import reactions
...
class reactions_slash_commands(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot

    @cog_ext.cog_slash(name = 'hi', description = 'hi to a friend or say hi to all users', guild_ids = [], options = optional)
    ...
    @cog_ext.cog_slash(name = 'poke', description = 'Give some lovely pokes to your friend', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'kiss', description = 'Give some kisses to your friend', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'slap', description = 'Slaps the tagged user', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'cuddle', description = 'snuggle up with your friend', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'hug', description = 'Give a hug to your friend', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'pat', description = 'Give some pats to your friend', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'baka', description = 'Call idiot (baka in Japanese) to the tagged user', guild_ids = [], options = obligatory)
    async def baka(self, ctx: SlashContext, mention : discord.Member=None):
        ...
        if lang == False:
            ...
            if mention == None:
                ...
                await ctx.send(text)
                return
            response = requests.get("https://nekos.best/api/v2/baka")
            data = json.loads(response.content)
    ...
    @cog_ext.cog_slash(name = 'feed', description = 'If someone is hungry feed them', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'tickle', description = 'A friend is sad Well, a good tickle will help him!', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'smug', description = 'show who you are... yeeahh!', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'run', description = 'Run run they catch you!!', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'dance', description = 'To dance! alone or with your friend', guild_ids = [], options = optional)
    ...
    @cog_ext.cog_slash(name = 'angry', description = 'Show your vilest anger', guild_ids = [], options = optional)
    ...
    @cog_ext.cog_slash(name = 'revive', description = 'revive your friend', guild_ids = [], options = obligatory)
    ...
    @cog_ext.cog_slash(name = 'happy', description = 'Explode with happiness', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'sad', description = 'Are you sad?, show your emotions', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'laugh', description = 'Laugh as much as you want or can!', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'cry', description = 'They have broken your heart... cry as much as you want', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'confused', description = 'Are you confused…? you don\'t understand…', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'bored', description = 'You don\'t know what to do, you feel bored', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'fbi', description = 'FBI OPEN UP!', guild_ids = [], options = [])
    ...
    @cog_ext.cog_slash(name = 'sleep', description = 'Did you fall asleep or… sleep with your friend', guild_ids = [], options = optional)
...
def setup(bot: commands.Bot):
    bot.add_cog(reactions_slash_commands(bot))
